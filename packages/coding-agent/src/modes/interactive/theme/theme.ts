...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@punkin-pi/tui";
...
// Embedded builtin themes - no filesystem access needed
...
const THEME_KEY = Symbol.for("@punkin-pi/coding-agent:theme");
...
export function getSettingsListTheme(): import("@punkin-pi/tui").SettingsListTheme {
	return {
